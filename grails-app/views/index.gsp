...
<html lang="es">
  ...
  <body>
    ...
    <div class="jumbotron home-bg">
      <div class="container">
        <h1 class="col-md-4 col-md-offset-3" style="color:#FFFFFF">genericPOS</h1>
        <h2 class="col-md-4 col-md-offset-3" style="color:#FFFFFF">Bienvenido</h2>
        <p><a class="btn btn-primary btn-lg col-md-4 col-md-offset-8" href="#" role="button">Regístrate</a></p>
      </div>
    </div>
